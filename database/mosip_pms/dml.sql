...
-- SKIP: device_detail not present in this setup
...
-- SKIP: secure_biometric_interface not present in this setup
...
-- SKIP: secure_biometric_interface_h not present in this setup
